...
- handle when direct dependency is unpublished ([5fedbd0](https://github.com/ext/npm-pkg-lint/commit/5fedbd010567053137816eaa85001eb45445280d))

## 2.4.0 (2024-04-07)

### Features

- add `--allow-dependency` to ignore disallowed dependency ([5b7939e](https://github.com/ext/npm-pkg-lint/commit/5b7939ed388777029cf2cfcb100dbcfaa3ae6b91))
